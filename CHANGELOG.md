...
## v1.2.0+26.3
- Change how beacon materials are determined so custom namespaces are preferred over the default
- Fix data packs not loading for namespaces other than `material_beacons`
